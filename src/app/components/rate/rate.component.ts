...
//   getRate() {
//     this.rateService.getByOrderDetail(this.orderdetail.billdetailid).subscribe(data => {
...
//           'productdetail': new FormControl(new Product(this.rate.productdetail.id)),
//           'orderdetail': new FormControl(new OrderDetail(this.rate.orderdetail.billdetailid))
//         })
//       }
//     }, error => {
...
//         this.rate.productdetail = this.orderdetail.productdetail;
